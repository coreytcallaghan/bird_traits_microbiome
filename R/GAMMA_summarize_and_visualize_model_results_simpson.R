...
############################
############################
mass_draws <- readRDS("intermediate_results/gamma_single_regression_ISimpson_draws_Mass.RDS")
mass_fe_only <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_Mass.RDS")
mass_fe_only_mean <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_mean_Mass.RDS")
...
mass_plot_raw <- ggplot()+
  geom_point(data=mass_data, aes(x=Mass, y=gamma_ISimpson), alpha=0.4)+
  ...
  theme(axis.text=element_text(color="black"))+
  xlab("Body mass (g)")+
  ylab("Microbial species diversity")+
  ggtitle("A")
...
##################################
##################################
Range.Size_draws <- readRDS("intermediate_results/gamma_single_regression_ISimpson_draws_Range.Size.RDS")
Range.Size_fe_only <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_Range.Size.RDS")
Range.Size_fe_only_mean <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_mean_Range.Size.RDS")
...
Range.Size_plot <- ggplot()+
  geom_point(data=Range.Size_data, aes(x=Range.Size, y=gamma_ISimpson), alpha=0.4)+
...
########################################
########################################
habitat_breadth_draws <- readRDS("intermediate_results/gamma_single_regression_ISimpson_draws_habitat_breadth.RDS")
habitat_breadth_fe_only <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_habitat_breadth.RDS")
habitat_breadth_fe_only_mean <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_mean_habitat_breadth.RDS")
...
habitat_breadth_plot <- ggplot()+
  geom_point(data=habitat_breadth_data, aes(x=habitat_breadth, y=gamma_ISimpson), alpha=0.4)+
...
###################################
###################################
flock_size_draws <- readRDS("intermediate_results/gamma_single_regression_ISimpson_draws_mean_flock_size.RDS")
flock_size_fe_only <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_mean_flock_size.RDS")
flock_size_fe_only_mean <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_mean_mean_flock_size.RDS")
...
flock_size_plot_raw <- ggplot()+
  geom_point(data=flock_size_data, aes(x=mean_flock_size, y=gamma_ISimpson), alpha=0.4)+
...
###################################
###################################
pop_abund_draws <- readRDS("intermediate_results/gamma_single_regression_ISimpson_draws_pop_abund.RDS")
pop_abund_fe_only <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_pop_abund.RDS")
pop_abund_fe_only_mean <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_mean_pop_abund.RDS")
...
pop_abund_plot_raw <- ggplot()+
  geom_point(data=pop_abund_data, aes(x=pop_abund, y=gamma_ISimpson), alpha=0.4)+
...
###################################
###################################
habitat_draws <- readRDS("intermediate_results/gamma_single_regression_ISimpson_draws_Habitat.RDS")
habitat_fe_only <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_Habitat.RDS")
habitat_fe_only_mean <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_mean_Habitat.RDS")
...
###################################
###################################
trophic_niche_draws <- readRDS("intermediate_results/gamma_single_regression_ISimpson_draws_Trophic.Niche.RDS")
trophic_niche_fe_only <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_Trophic.Niche.RDS")
trophic_niche_fe_only_mean <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_mean_Trophic.Niche.RDS")
...
###################################
###################################
trophic_level_draws <- readRDS("intermediate_results/gamma_single_regression_ISimpson_draws_Trophic.Level.RDS")
trophic_level_fe_only <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_Trophic.Level.RDS")
trophic_level_fe_only_mean <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_mean_Trophic.Level.RDS")
...
###################################
###################################
primary_lifestyle_draws <- readRDS("intermediate_results/gamma_single_regression_ISimpson_draws_Primary.Lifestyle.RDS")
primary_lifestyle_fe_only <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_Primary.Lifestyle.RDS")
primary_lifestyle_fe_only_mean <- readRDS("intermediate_results/gamma_single_regression_ISimpson_fe_only_mean_Primary.Lifestyle.RDS")
