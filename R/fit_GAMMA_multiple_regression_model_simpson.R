...
mod_with <- brms::brm(gamma_ISimpson ~ log10(Mass) + log10(Range.Size) + log10(habitat_breadth) +
                      ...
                      file=paste0("model_objects/gamma_multiple_regression_simpson.RDS"))
...
draws <- mod_with %>%
  spread_draws(b_Intercept, 
               ...
               b_Trophic.LevelHerbivore, b_Trophic.LevelOmnivore, b_Primary.LifestyleInsessorial, b_Primary.LifestyleTerrestrial)

saveRDS(draws, paste0("intermediate_results/gamma_multiple_regression_simpson_draws.RDS"))
...
saveRDS(out_df, paste0("intermediate_results/gamma_multiple_regression_simpson_summary.RDS"))
